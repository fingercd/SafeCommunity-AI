...
- 检查 RTSP 地址里有没有账号密码。
- 检查配置里有没有本机绝对路径。
- 检查是否误提交大模型权重、训练产物、缓存文件。
- 在 README 中明确说明“当前推荐主流程”和“历史方案仅供参考”。

## 本次文档补充建议你重点看

- `yolo/README.md`
- `Vit/README.md`
- `Vit/lab_anomaly/README.md`
- `vlm/README.md`
- `web/README.md`

这些文件会分别从各自模块内部把架构、入口、配置和注意事项讲清楚。

## 说明

本项目更适合研究、实验和二次开发场景。  
如果你后续要把它整理成对外开源版本，建议下一步继续做两件事：

1. 统一各模块的路径配置方式。
2. 把 `Vit` 中已经过时的旧说明明确标成“历史文档”。
