...
class YOLO(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : r"C:\Users\Administrator\Desktop\moniter\yolo\logs\best_epoch_weights.pth",
        "classes_path"      : r"C:\Users\Administrator\Desktop\moniter\yolo\Class\coco_classes.txt",
        #---------------------------------------------------------------------#
        #   输入图片的大小，必须为32的倍数。
        #---------------------------------------------------------------------#
        "input_shape"       : [640, 640],
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        if crop:
            for i, c in list(enumerate(top_boxes)):
                class_index = int(c)
                # 模型预测的类别名称（对应strawberry_classes.txt）
        ...
        for i, c in list(enumerate(top_label)):
            ...
            # 新代码（替换为）
            # 获取文本边界框 (x0, y0, x1, y1)，其中(x1-x0)是宽度，(y1-y0)是高度
